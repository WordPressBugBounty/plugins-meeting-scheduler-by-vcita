...
wp_enqueue_script('vcita-colorpicker', WPSHD_VCITA_ASSETS_PATH.'/assets/extra/colorpicker/js/colorpicker.js', array('jquery'), WPSHD_VCITA_WIDGET_VERSION, true);
wp_enqueue_script('vcita-add-to-site-script', WPSHD_VCITA_ASSETS_PATH.'assets/js/add_to_site_v.js', array('jquery','vcita-colorpicker'), WPSHD_VCITA_WIDGET_VERSION, true);
...
wp_enqueue_style('vcita-add-to-site-style', WPSHD_VCITA_ASSETS_PATH.'assets/style/add_to_site_v.css', array(), WPSHD_VCITA_WIDGET_VERSION);
wp_enqueue_style('vcita-colorpicker', WPSHD_VCITA_ASSETS_PATH.'/assets/extra/colorpicker/css/colorpicker.css', array(), WPSHD_VCITA_WIDGET_VERSION);
...
foreach ($wpshd_vcita_widget_config as $wpshd_vcita_key => $wpshd_vcita_val) {
    $wpshd_vcita_widget[$wpshd_vcita_key] = $wpshd_vcita_val;
}
    ...
    <div class="vcita-wrap-inner">
        <?php if (WPSHD_VCITA_ANOTHER_PLUGIN) { ?>
            ...
            ?>
                <div class="vcita__page__error-container">
                    As you already use <b><?php echo esc_html( $wpshd_vcita_plugin_str ) ?></b> by vcita, you can edit the scheduling widget there.
        ...
        <?php } else { ?>
            <div class="vcita__page__inner__section <?php echo $wpshd_vcita_widget['show_on_site'] && (($wpshd_vcita_widget['uid'] || !$wpshd_vcita_widget['vcita_design'])) ? 'no-margin' : '' ?>">
                <h3>
                    <?php echo esc_html( $wpshd_vcita_widget['migrated'] ? __('Show widget on site', 'meeting-scheduler-by-vcita') : __('Show on site', 'meeting-scheduler-by-vcita') ) ?>
                    <div class="vcita__toggle__checkbox-container" style="float: right">
                        <input type="checkbox"
                            ...
                            value="<?php echo esc_attr( $wpshd_vcita_widget['show_on_site'] ) ?>"
                    ...
                    <?php if ($wpshd_vcita_widget['uid'] && !$wpshd_vcita_needs_reconnect) { ?>
                        <small class="vcita__toggle__checkbox-show-text<?php echo($wpshd_vcita_widget['show_on_site'] ? '' : ' hidden') ?>">
                            <?php echo esc_html__('Hooray! Your clients can book with you right from your site', 'meeting-scheduler-by-vcita') ?>
                        </small>
                    <?php } else { ?>
                        <small class="vcita__toggle__checkbox-show-text<?php echo($wpshd_vcita_widget['show_on_site'] ? '' : ' hidden') ?>">
                            <?php echo esc_html__('The widget will be added to your site once you connect to vcita', 'meeting-scheduler-by-vcita') ?>
                    ...
                    <small class="vcita__toggle__checkbox-hide-text<?php echo(!$wpshd_vcita_widget['show_on_site'] ? '' : ' hidden') ?>">
                        <?php if (WPSHD_VCITA_ANOTHER_PLUGIN) { ?>
                            <?php echo esc_html__('The scheduling widget is already shown on your site by another vcita plugin you use. Hence, we disabled the option to turn this switch on.', 'meeting-scheduler-by-vcita') ?>
                        <?php } else { ?>
                            <?php echo esc_html__('Turn the switch on to add vcita`s scheduling widget to your site!', 'meeting-scheduler-by-vcita') ?>
                            <?php if (!$wpshd_vcita_widget['uid'] || $wpshd_vcita_needs_reconnect) { ?>
                                <p><button class="vcita__btn__blue start-signup-add clickme">
                                    <?php echo esc_html__('Connect to vcita', 'meeting-scheduler-by-vcita') ?>
                                </button></p>
                ...
                <div class="vcita__page__inner__section <?php echo !$wpshd_vcita_widget['show_on_site'] ? 'hidden' : '' ?>">
                    <form class="vcita__page__inner__section-banner <?php echo !$wpshd_vcita_widget['vcita_design'] ? 'content-stretched' : '' ?>">
                        <div class="vcita__page__inner__section-banner-img <?php echo $wpshd_vcita_widget['vcita_design'] ? 'hidden' : '' ?>">
                            <header>
                                <?php echo esc_html__('Mobile preview', 'meeting-scheduler-by-vcita') ?>
                                <div><?php echo esc_html__('(also supported on desktop)', 'meeting-scheduler-by-vcita') ?></div>
                            </header>
                            <div class="vcita__widget__preview__container">
                                <div class="vcita__widget__preview__container-inner <?php echo !$wpshd_vcita_widget['widget_show'] ? 'no-background' : '' ?>">
                                    ...
                                    <div class="vcita__widget__preview__container-inner-header flex vcentered <?php echo !$wpshd_vcita_widget['widget_show'] ? 'hidden_from_view' : '' ?>">
                                        ...
                                        <span>
                                            <?php echo !empty($wpshd_vcita_widget['widget_title']) ? esc_html($wpshd_vcita_widget['widget_title']) : esc_html__('Let\'s talk!', 'meeting-scheduler-by-vcita') ?>
                                        </span>
                                    </div>
                                    <div class="vcita__widget__preview__container-inner-text <?php echo !$wpshd_vcita_widget['widget_show'] ? 'hidden_from_view' : '' ?>">
                                        <?php echo !empty($wpshd_vcita_widget['widget_text']) ? esc_html($wpshd_vcita_widget['widget_text']) : esc_html__('Thanks for stopping by! We\'re here to help…', 'meeting-scheduler-by-vcita') ?>
                                    </div>
                                    <div class="vcita__widget__preview__container-inner-button">
                                        <button onclick="event.preventDefault();event.stopPropagation();" class="vcita_schedule_button<?php echo !$wpshd_vcita_widget['widget_show'] ? ' big' : '' ?>">
                                            <?php echo !empty($wpshd_vcita_widget['btn_text']) ? esc_html($wpshd_vcita_widget['btn_text']) : esc_html__('Schedule Now', 'meeting-scheduler-by-vcita') ?>
                                        </button>
                                        <!--<span class="vcita_burger_btn"><span></span></span>-->
                                    </div>
                                </div>
                                <iframe id="preview_iframe" src="<?php echo esc_url( add_query_arg( 'WPSCHD_DISABLE_BUTTON', '1', home_url( '/' ) ) ) ?>" width="153" height="335"></iframe>
                                ...
                                <img src="<?php echo esc_url( WPSHD_VCITA_ASSETS_PATH ) ?>/images/assets/phone-mockup-2.svg" alt="phone mockup"/>
                            </div>
                        </div>
                        <?php if ($wpshd_vcita_widget['uid']) { ?>
                            <section>
                                <h3 class="no-margin">
                                    <?php echo esc_html__('Take design from', 'meeting-scheduler-by-vcita') ?>&nbsp;
                                    <i class="vcita_info" title="<?php echo esc_html__('You can either set the widget design here, or on vcita website if you wish to utilize more advanced features', 'meeting-scheduler-by-vcita') ?>">i</i>
                                </h3>
                                <div class="vcita__input__select txt_input">
                                    <select name="design" onchange="vcita_toggle_design_view(this,this.value)">
                                        <option value="0" <?php echo $wpshd_vcita_widget['vcita_design'] ? '' : 'selected' ?>>
                                            <?php echo esc_html__('Plugin', 'meeting-scheduler-by-vcita') ?>
                                        </option>
                                ...
                                <a href="javascript:void(0)" onclick="vcita_show_edit_livesite(event)">
                                    <?php echo esc_html__('Edit on vcita', 'meeting-scheduler-by-vcita') ?>
                                </a>
                            </section>
                        <?php } ?>
                        <section <?php echo $wpshd_vcita_widget['vcita_design'] ? 'class="hidden"' : '' ?>>
                            <h3 <?php echo !($wpshd_vcita_widget['migrated'] && $wpshd_vcita_widget['uid']) ? 'class="no-margin"' : '' ?>>
                                <?php echo esc_html__('Design', 'meeting-scheduler-by-vcita') ?>
                            </h3>
                        </section>
                        <section <?php echo $wpshd_vcita_widget['vcita_design'] ? 'class="hidden"' : '' ?>>
                            <h4><?php echo esc_html__('Button text', 'meeting-scheduler-by-vcita') ?></h4>
                            <input type="text" placeholder="<?php echo esc_html__('Schedule Now', 'meeting-scheduler-by-vcita') ?>" style="width: 100%;" class="txt_input" name="btn_text" oninput="vcita_design_change(this)" value="<?php echo esc_attr($wpshd_vcita_widget['btn_text']) ?>">
                        </section>
                        <section class="divided flex flex-wrap hspaced <?php echo $wpshd_vcita_widget['vcita_design'] ? 'hidden' : '' ?>">
                            <div>
                                <h4><?php echo esc_html__('Button color', 'meeting-scheduler-by-vcita') ?></h4>
                            ...
                            <div>
                                <h4><?php echo esc_html__('Text color', 'meeting-scheduler-by-vcita') ?></h4>
                            ...
                            <div>
                                <h4><?php echo esc_html__('Hover color', 'meeting-scheduler-by-vcita') ?></h4>
                        ...
                        <section <?php echo $wpshd_vcita_widget['vcita_design'] ? 'class="hidden"' : '' ?>>
                            <h3>
                                <?php echo esc_html__('Pop up after 5 seconds', 'meeting-scheduler-by-vcita') ?>
                                <div class="vcita__toggle__checkbox-container" style="float: right">
                        ...
                        <section class="vcita_section_toggle-view <?php echo !$wpshd_vcita_widget['widget_show'] || $wpshd_vcita_widget['vcita_design'] ? 'hidden_from_view' : '' ?>">
                            <h4><?php echo esc_html__('Widget title', 'meeting-scheduler-by-vcita') ?></h4>
                            <input type="text" placeholder="<?php echo esc_html__('Let\'s Talk!', 'meeting-scheduler-by-vcita') ?>" style="width: 100%;" oninput="vcita_design_change(this)" class="txt_input" name="widget_title" value="<?php echo esc_attr($wpshd_vcita_widget['widget_title']) ?>">
                        </section>
                        <section class="vcita_section_toggle-view <?php echo !$wpshd_vcita_widget['widget_show'] || $wpshd_vcita_widget['vcita_design'] ? 'hidden_from_view' : '' ?>">
                            <h4><?php echo esc_html__('Widget text', 'meeting-scheduler-by-vcita') ?></h4>
                            <input type="text" placeholder="<?php echo esc_html__('Thanks for stopping by! We\'re here to help…', 'meeting-scheduler-by-vcita') ?>" style="width: 100%;" oninput="vcita_design_change(this)" class="txt_input" name="widget_text" value="<?php echo esc_attr($wpshd_vcita_widget['widget_text']) ?>">
                        </section>
                        <section class="vcita_section_toggle-view vcita_image_attach_container <?php echo !$wpshd_vcita_widget['widget_show'] || $wpshd_vcita_widget['vcita_design'] ? 'hidden_from_view' : '' ?>">
                            <h4><?php echo esc_html__('Widget image (Optional)', 'meeting-scheduler-by-vcita') ?></h4>
                            ...
                            <a href="javascript:void(0)" onclick="vcita_clear_fileinput(event,this)">
                                <?php echo esc_html__('Clear', 'meeting-scheduler-by-vcita') ?>
                            </a>
                        ...
                        <section <?php echo $wpshd_vcita_widget['vcita_design'] ? 'class="hidden"' : '' ?>>
                            <button class="vcita__btn__blue" onclick="event.preventDefault();event.stopPropagation();vcita_save_design(this,this.closest('form'));">
                                <?php echo esc_html__('Save', 'meeting-scheduler-by-vcita') ?>
                            </button>
                        </section>
                        <section <?php echo $wpshd_vcita_widget['vcita_design'] ? 'class="hidden"' : '' ?>>
                            <h4>
                                <?php echo esc_html__('Not satisfied with the result?', 'meeting-scheduler-by-vcita') ?>
                                &nbsp;&nbsp;
                                <a href="javascript:void(0)" onclick="vcita_reset_design(this)">
                                    <?php echo esc_html__('Reset to default', 'meeting-scheduler-by-vcita') ?>
                                </a>
                            </h4>
                        </section>
                    </form>
            ...
            <?php if ($wpshd_vcita_widget['uid'] || $wpshd_vcita_needs_reconnect) { ?>
                <div class="vcita__page__inner__section no-hide">
                    <h3>
                        <?php echo esc_html__('Contact Form', 'meeting-scheduler-by-vcita') ?>
                        <div style="float:right;text-align:right">
                            <div class="vcita__toggle__checkbox-container">
                                <input type="checkbox" name="contact_page_active"
                                    ...
                                    value="<?php echo esc_attr( $wpshd_vcita_widget['contact_page_active'] ) ?>"
                            ...
                            <div class="<?php echo $wpshd_vcita_widget['contact_page_active'] ? '' : 'hidden' ?>">
                                <a href="<?php echo esc_url( wpshd_vcita_get_contact_url($wpshd_vcita_widget) );?>" target="_blank">
                        ...
                        <?php if (!WPSHD_VCITA_ANOTHER_PLUGIN) { ?>
                            <small class="vcita__toggle__checkbox-hide-text<?php echo(!$wpshd_vcita_widget['contact_page_active'] ? '' : ' hidden') ?>">
                                <?php echo esc_html__('Turn switch on to add your vcita contact form on your website', 'meeting-scheduler-by-vcita') ?>
                            </small>
                            <small class="vcita__toggle__checkbox-hide-text<?php echo($wpshd_vcita_widget['contact_page_active'] ? '' : ' hidden') ?>">
                                <?php echo esc_html__('Your vcita contact form is active on your site.', 'meeting-scheduler-by-vcita') ?>
                                <a href="https://app.<?php echo esc_attr( WPSHD_VCITA_SERVER_BASE ) ?>/app/my-livesite?section=website-widgets" target="_blank">
                                    <?php echo esc_html__('Edit form', 'meeting-scheduler-by-vcita') ?>
                                </a>
                            </small>
                        <?php } else { ?>
                            <small class="vcita__toggle__checkbox-hide-text">
                                <?php echo esc_html__('The scheduling widget is already presented on your site. We block the option to turn contact page on here as well.', 'meeting-scheduler-by-vcita') ?>
                            </small>
                        <?php } ?>
                    </h3>
                </div>
                <div class="vcita__page__inner__section no-hide">
                    <h3>
                        <?php echo esc_html__('Scheduling Page', 'meeting-scheduler-by-vcita') ?>
                        <div style="float:right;text-align:right">
                            <div class="vcita__toggle__checkbox-container">
                                <input type="checkbox" name="calendar_page_active"
                                    ...
                                    value="<?php echo esc_attr( $wpshd_vcita_widget['calendar_page_active'] ) ?>"
                            ...
                            <div class="<?php echo $wpshd_vcita_widget['calendar_page_active'] ? '' : 'hidden' ?>">
                                <a href="<?php echo esc_url( wpshd_vcita_get_schedule_url($wpshd_vcita_widget) );?>" target="_blank">
                                    <?php echo esc_html__('Preview', 'meeting-scheduler-by-vcita') ?>
                                </a>
                            </div>
                        </div>
                        <?php if (!WPSHD_VCITA_ANOTHER_PLUGIN) { ?>
                            <small class="vcita__toggle__checkbox-hide-text<?php echo(!$wpshd_vcita_widget['calendar_page_active'] ? '' : ' hidden') ?>">
                                <?php echo esc_html__('Turn switch on to add a scheduling page to your website', 'meeting-scheduler-by-vcita') ?>
                            </small>
                            <small class="vcita__toggle__checkbox-hide-text<?php echo($wpshd_vcita_widget['calendar_page_active'] ? '' : ' hidden') ?>">
                                <?php echo esc_html__('Your scheduling page is active on your site', 'meeting-scheduler-by-vcita') ?>
                            </small>
                        <?php } else { ?>
                            <small class="vcita__toggle__checkbox-hide-text">
                                <?php echo esc_html__('The scheduling widget is already presented on your site. We block the option to turn scheduling page on here as well.', 'meeting-scheduler-by-vcita') ?>
                            </small>
                        <?php } ?>
                    </h3>
                </div>
            <?php } ?>
            <?php if (($wpshd_vcita_widget['uid'] || $wpshd_vcita_needs_reconnect) && !WPSHD_VCITA_ANOTHER_PLUGIN) { ?>
                <div class="vcita__page__inner__section no-hide">
                    <h3>
                        <?php echo esc_html__('More options', 'meeting-scheduler-by-vcita') ?>
                        <small>
                            <?php echo esc_html__('Enable clients to book meetings with you right from your Facebook / Google page', 'meeting-scheduler-by-vcita') ?>
                        </small>
                    </h3>
                    <div class="vcita__page__inner__section-no-padding flex flex-wrap hspaced">
                        <div class="vcita__page__add-to-site__more-options">
                            <img src="<?php echo esc_url( WPSHD_VCITA_ASSETS_PATH ) ?>/images/assets/white-copy.png"/>
                            <div>
                                <img src="<?php echo esc_url( WPSHD_VCITA_ASSETS_PATH ) ?>/images/assets/google-2015-logo.png"/>
                                <article>
                                    <?php echo esc_html__('Add a book button to your Google page', 'meeting-scheduler-by-vcita') ?>
                                </article>
                                <a href="javascript:void(0)" onclick="VcitaUI.openSyncGoogleWin()">
                                    <?php echo esc_html__('Add Google Reserve', 'meeting-scheduler-by-vcita') ?>
                                </a>
                            </div>
                        </div>
                        <div class="vcita__page__add-to-site__more-options">
                            <img src="<?php echo esc_url( WPSHD_VCITA_ASSETS_PATH ) ?>/images/assets/white.png"/>
                            <div>
                                <img style="margin-bottom:5px" src="<?php echo esc_url( WPSHD_VCITA_ASSETS_PATH ) ?>/images/assets/facebook-logo-2019.png"/>
                                <article>
                                    <?php echo esc_html__('Add a book button to your Facebook page', 'meeting-scheduler-by-vcita') ?>
                                </article>
                                <a href="javascript:void(0)" onclick="VcitaUI.openSyncFacebookWin()">
                                    <?php echo esc_html__('Add on Facebook', 'meeting-scheduler-by-vcita') ?>
                                </a>
                            </div>
                        </div>
                    </div>
